...
namespace DX12Playground {
    ...
    void UI::Render()
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            //if (ImGui::InputFloat4("Offset", (float*)&offset)) {
            //    should_update_cb = true;
            //}
            //if (ImGui::SliderFloat4("Offset", (float*)&offset, -1.0f, 1.0f)) {
            //    should_update_cb = true;
            //}
            if (ImGui::SliderFloat("Offset", (float*)&offset.x, -1.0f, 1.0f)) {
                should_update_cb = true;
            }
